...
const services = [
    { origin_path: "users/login", destination_url: "http://localhost", destination_path: "users/login", port: 8182 },
    { origin_path: "users", destination_url: "http://localhost", destination_path: "users", port: 8182 },
];
let urlPath;
